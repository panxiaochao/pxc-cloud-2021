...
// return unauthorizedResponse(exchange, "Illegal request to disable access [request url
// is inner]");
// }
//
// // 3.获取Token
...
// token.startsWith(GatewayGlobalConstant.ACCESS_TOKEN_PREFIX)) {
// token = token.replaceFirst(GatewayGlobalConstant.ACCESS_TOKEN_PREFIX,
// StringUtils.EMPTY);
// }
// return token;
// }
...
// return WebFluxUtil.webFluxResponseWriter(exchange.getResponse(), msg,
